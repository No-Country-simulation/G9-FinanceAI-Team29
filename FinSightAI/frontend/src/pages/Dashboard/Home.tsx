      ...
      <>
        ...
        <div className="mx-auto flex min-h-[620px] max-w-5xl items-center justify-center px-4 py-8">
          <div className="w-full overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-lg dark:border-gray-800 dark:bg-gray-900">
            <div className="bg-gradient-to-br from-brand-500 via-brand-600 to-purple-600 px-6 py-12 text-center text-white sm:px-12">
              <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-2xl bg-white/15 text-4xl shadow-inner backdrop-blur">
                ✨
              </div>
              ...
              <p className="mx-auto max-w-2xl text-base leading-7 text-white/90 sm:text-lg">
                Tu cuenta ya está lista. Importá tus movimientos y transformalos
                en información clara para entender tus ingresos, gastos, ahorro y
                perfil financiero.
              </p>
            </div>
            ...
            <div className="grid gap-8 px-6 py-10 sm:px-10 lg:grid-cols-[1fr_0.9fr] lg:px-12">
              <div>
                ...
                <div className="space-y-4">
                  {[
                    ['📊', 'Dashboard financiero', 'Visualizá ingresos, gastos y evolución mensual.'],
                    ['🤖', 'Análisis con IA', 'Descubrí patrones y recibí recomendaciones personalizadas.'],
                    ['🎯', 'Perfil financiero', 'Conocé tu nivel de salud financiera y oportunidades de mejora.'],
                    ['🔎', 'Categorías automáticas', 'Organizá tus movimientos para entender dónde se va tu dinero.'],
                  ].map(([icono, titulo, descripcion]) => (
                    <div
                      key={titulo}
                      className="flex gap-4 rounded-2xl border border-gray-100 p-4 dark:border-gray-800"
                    >
                      <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-brand-50 text-xl dark:bg-brand-500/10">
                        {icono}
                      </div>
              ...
              <div className="flex flex-col justify-center rounded-2xl bg-gray-50 p-6 dark:bg-white/[0.03] sm:p-8">
                <div className="mb-6 text-center">
                  <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-brand-100 text-3xl dark:bg-brand-500/15">
                    📄
                  </div>

                  <h2 className="mb-2 text-xl font-semibold text-gray-800 dark:text-white/90">
                    Cargá tu primer archivo
                  </h2>

                  <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
                    Seleccioná un archivo CSV con tus movimientos financieros.
                    FinSightAI se encargará de procesarlo y analizarlo.
                  </p>
                </div>
                ...
                <button
                  ...
                  className="inline-flex w-full items-center justify-center rounded-xl bg-brand-500 px-5 py-3.5 text-sm font-semibold text-white transition hover:bg-brand-600"
                >
                  📄 Cargá tu CSV aquí
                </button>

                <p className="mt-4 text-center text-xs leading-5 text-gray-400">
                  Tus datos se utilizan únicamente para generar tu análisis financiero.
                </p>
              </div>
            </div>
          </div>
