...
export default function Metas() {
  ...
  return <>
    ...
    <div className="space-y-6">
      ...
      {loading ? <div className="py-12 text-center text-gray-500">Cargando metas…</div> : active.length === 0 ? <div className="rounded-2xl border border-dashed border-gray-300 p-10 text-center dark:border-gray-700"><p className="font-medium text-gray-900 dark:text-white">Todavía no tenés metas activas</p><p className="mt-1 text-sm text-gray-500">Creá la primera para empezar a medir tu progreso.</p></div> :
