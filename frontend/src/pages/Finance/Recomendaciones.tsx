    ...
    const fetchData = async () => {
      try {
        const request = {
          ...
          // El backend valida frecuenciaAhorro ∈ {Alta, Media, Baja, Nunca}
          // y montos positivos (cada transacción es un gasto).
        ...
        const result = await analizarFinanzas(request);
        setResultado(result);
      } catch (err) {
        console.error(err);
      } finally {
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                  ...
                  <p className="text-lg font-bold text-success-600">{resultado.porcentajeAhorro.toFixed(1)}%</p>
                </div>
              </div>
            </div>
