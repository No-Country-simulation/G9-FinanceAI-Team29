...
/**
 * Clasifica una transacción en una categoría a partir de su descripción.
 *
 * Se usa un {@link LinkedHashMap} (no {@code Map.of}) para garantizar un orden
 * de evaluación DETERMINISTA: las categorías más específicas se comprueban antes
 * que las genéricas, de modo que descripciones ambiguas siempre caen en la misma
 * categoría. "Otros" es el valor por defecto cuando no coincide ningún patrón.
 */
@Service
