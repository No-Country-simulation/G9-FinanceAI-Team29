...
public class CsvImportResponse {
    ...
    public UsuarioCsv getUsuario() {
        return usuario;
    }

    public void setUsuario(UsuarioCsv usuario) {
        this.usuario = usuario;
    }

    public List<TransaccionCsv> getTransacciones() {
        return transacciones;
    }

    public void setTransacciones(List<TransaccionCsv> transacciones) {
        this.transacciones = transacciones;
    }

    public ResumenCsv getResumen() {
        return resumen;
    }

    public void setResumen(ResumenCsv resumen) {
    ...
    public static class UsuarioCsv {
        ...
        @JsonProperty("porcentaje_ahorro_ingreso")
        private BigDecimal porcentajeAhorroIngreso;
        ...
        public BigDecimal getPorcentajeAhorroIngreso() {
            return porcentajeAhorroIngreso;
        }

        public void setPorcentajeAhorroIngreso(BigDecimal porcentajeAhorroIngreso) {
            this.porcentajeAhorroIngreso = porcentajeAhorroIngreso;
        }
